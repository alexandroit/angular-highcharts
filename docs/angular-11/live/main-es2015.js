...
module.exports = __webpack_require__(/*! /storage/data/github/tests/angular-highcharts/angular-11/src/main.ts */"zUnb");
    ...
    makeBasic(title, description, type) {
        return {
            ...
            options: {
                ...
                title: { text: title },
                subtitle: { text: '@stackline/angular-highcharts Angular 11 live test' },
                xAxis: { categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'] },
                yAxis: { title: { text: 'Requests' } },
                series: [
