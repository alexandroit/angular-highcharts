    ...
    AppComponent.prototype.makeBasic = function (title, description, type) {
        return {
            ...
            options: {
                ...
                title: { text: title },
                subtitle: { text: '@stackline/angular-highcharts Angular 7 live test' },
                xAxis: { categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'] },
                yAxis: { title: { text: 'Requests' } },
                series: [
...
module.exports = __webpack_require__(/*! /storage/data/github/tests/angular-highcharts/angular-7/src/main.ts */"./src/main.ts");
